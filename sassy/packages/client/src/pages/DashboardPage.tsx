      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl p-8 text-white mb-8">
          ...
          <p className="text-blue-100">
            Chào mừng bạn quay trở lại Sassy App
          </p>
        </div>
        ...
        {/* Getting Started */}
        <div className="bg-white rounded-lg shadow-sm p-6">
          <h2 className="text-lg font-semibold mb-4">Bắt đầu</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <a
              href="/teams"
            ...
            >
              ...
              <div>
                <p className="font-medium text-gray-900">Tạo Team</p>
                <p className="text-sm text-gray-500">Mời thành viên cộng tác</p>
              </div>
            </a>
            <a
              href="/projects"
            ...
            >
              ...
              <div>
                <p className="font-medium text-gray-900">Tạo Project</p>
